...
app.put("/lista/:id_lista", function (req, res) {
...
app.delete("/lista/:id_lista", function (req, res) {
...
app.post("/lista/:id_lista", function (req, res) {
...
app.put("/lista/:id_lista/tarefa/:id_tarefa", function (req, res) {
  // Pega as informações provenientes da request (body e parâmetros)
  var idLista = req.params.id_lista;
...
app.delete("/lista/:id_lista/tarefa/:id_tarefa", function (req, res) {
  // Pega as informações provenientes da request (body e parâmetros)
  var idLista = req.params.id_lista;
  var idTarefa = req.params.id_tarefa;
  // Apagar tarefa
...
app.get("/lista/:id_lista/tarefa", function (req, res) {
